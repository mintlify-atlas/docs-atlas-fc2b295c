...
<Info>
  Bundle simulation via `eth_callBundle` is included in the BSC Package subscription at **$1,250/month**. It is also available as part of the Call Bundle service tier. See [Pricing](https://blockrazor.io/#/pricing) for details.
</Info>
