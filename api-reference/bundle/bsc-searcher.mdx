---
title: "BSC Bundle Orderflow Auction API for Searchers"
sidebarTitle: "BSC Searcher"
description: "Submit competitive bids in BSC orderflow auctions using eth_sendMevBundle to win the right to backrun a signal transaction."
---
