...
sidebarTitle: "Sui Execute Tx Block"
description: "Execute Sui transaction blocks at high speed through BlockRazor's Fast mode endpoint using the sui_executeTransactionBlock method with TypeScript and Go examples."
---
