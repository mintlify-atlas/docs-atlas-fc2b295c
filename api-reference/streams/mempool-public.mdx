---
title: "BSC Public Mempool WebSocket Stream — BlockRazor"
sidebarTitle: "Public Mempool"
description: "Subscribe to BlockRazor's BSC public mempool WebSocket stream to monitor all pending transactions in real time for MEV strategies."
---
...
<Info>
  The Public Mempool stream is also available as part of the **BSC Package** bundle. See the [Pricing](/pricing) page for details.
</Info>
