...
<Tip>
  Combine a Mempool stream subscription with Bundle submission for the tightest end-to-end loop: detect the signal transaction the moment it is broadcast, immediately construct your bundle, and submit it through Fast mode so it reaches the validator with minimum propagation delay.
</Tip>
